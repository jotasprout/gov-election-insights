...
$getSocialistWinners = "SELECT m.stateAbbr, m.candidateID, m.candidateName, max(m.popVotes) AS mostVotes FROM
...
$getSocialistWinners2 = "SELECT m.stateAbbr, m.stateName, m.candidateID, m.candidateName, max(m.popVotes) AS mostVotes FROM
...
$result = mysqli_query($connekt, $getSocialistWinners2);
